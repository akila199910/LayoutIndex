...
<head>
    ...
    <script>
        $(document).ready(function() {
          // Initialize Choices for each element with the class "choices-single"
          ...
          // Initialize Choices for each element with the class "choices-multiple"
          document.querySelectorAll('.choices-multiple').forEach(function(element) {
            new Choices(element, {
              searchEnabled: true,
              removeItemButton: true,  // Enables the cancel icon on selected items
              itemSelectText: '',
            });
          });
        });
